...
public class ANSIRenderer implements Renderer {
     ...
     */
    @Override
    public String render(Maze maze, List<Position> path) throws IllegalArgumentException {
     ...
     * It needed, because grid contains walls, which also took place on grid
     */
    ...
    /**
     * Add a path on already built maze grid
     *
